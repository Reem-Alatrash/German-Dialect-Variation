...
# use random slopes, meaning that the effect of speaker should be different for each spoken ngram
POSt.glmer <- glmer(corpus_type ~ 1 + pos_seq + (1+pos_seq|speaker), contrasts = my.contrasts,
